  ...
  <div class="modal-overlay">
    <div class="modal-content">
      ...
      <div class="summary-item">
        Total Tagihan: <span class="total-big">{{ formatCurrency(total) }}</span>
      </div>
      ...
      <div class="summary-item" v-if="method === 'Cash' && typeof amountReceived === 'number' && amountReceived > 0">
        Kembalian: <span :class="{'text-danger': changeAmount < 0}">{{ formatCurrency(changeAmount) }}</span>
      </div>
